...
close all
max_ecad=[];
C = {'b','b','b','b','b','b','b','b','r','r','r','r','r','r','r','r','m','m','c','c'};
for ii=1:size(processed_movies,2)
figure(2),p1(ii)= plot(processed_movies(ii).pxlint(2:end),'-p','Color',C{ii}); hold on
box on
h2 = figure(2);
...
legend([p1(1) p1(9) p1(17) p1(19)],{'Pre-differentaited unmixed','Pluripotent unmixed','Prediff, mixed with pluri','Pluri, mixed with prediff'});
