...
global userParam;
 ...
 userParam.arealow = 70;%70
 userParam.arealow_localnbr = 120;
 userParam.minpxloverlap = 0.06;%0.09
 ...
 userParam.local_sz =100;% 47 in pixels     % size of the cell neighborhood to be considered
